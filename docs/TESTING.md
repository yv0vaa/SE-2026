...
Документ описывает стратегию тестирования CLI Shell Interpreter, покрытие по компонентам и ожидаемое поведение (вход/выход) для ключевых тестов.
...
| Краевые случаи | test_edge_cases   | Кавычки, переменные, коды возврата, внешние команды, пайплайны |
...
| test_edge_cases.cpp   | Кавычки, переменные, коды возврата, внешние команды, пайплайны |
